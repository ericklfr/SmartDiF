...
def composeFinalFeatureVector(image,descriptor="ACC",space=4,channel=3,illuminantType="GGE"):
    ...
    while (cont <= numberFaces):
        faceName = "tifs2016/data-base/faces/face-" + str(cont) + ".png"
        print("Antes do extrator")
        extractDescriptor.extractDescriptor(faceName,descriptor,space,channel)
        cont = cont + 1
        print("Passou do extrator")
        nameFaces = "tifs2016/face-positions/" + image[:-4] + ".txt"
    ...
    while (firstFace < numberFaces):
        ...
        while (secondFace <= numberFaces):
            ...
            if (descriptor == "acc"):
                nf1 = "tifs2016/temp/faces/face-" + str(firstFace) + "-acc-descriptor.txt"
                nf2 = "tifs2016/temp/faces/face-" + str(secondFace) + "-acc-descriptor.txt"
                files = open(nf1,"rt")
                files.seek(0)
                temp = files.readline()
                ...
                nf1 = "tifs2016/temp/faces/face-" + str(firstFace) + "-bic-descriptor.txt"
                nf2 = "tifs2016/temp/faces/face-" + str(secondFace) + "-bic-descriptor.txt"
                files = open(nf1,"rb")
                files.seek(0)
                temp = files.readline()
                linesf1 = files.readlines()
                ...
                nf1 = "tifs2016/temp/faces/face-" + str(firstFace) + "-las-descriptor.txt"
                nf2 = "tifs2016/temp/faces/face-" + str(secondFace) + "-las-descriptor.txt"
                files = open(nf1,"rt")
                files.seek(0)
                temp = files.readline()
                linesf1 = files.readlines()
                ...
                nf1 = "tifs2016/temp/faces/face-" + str(firstFace) + "-sasi-descriptor.txt"
                nf2 = "tifs2016/temp/faces/face-" + str(secondFace) + "-sasi-descriptor.txt"
                files = open(nf1,"rt")
                files.seek(0)
                temp = files.readline()
                linesf1 = files.readlines()
                ...
                nf1 = "tifs2016/temp/faces/face-" + str(firstFace) + "-unser-descriptor.txt"
                nf2 = "tifs2016/temp/faces/face-" + str(secondFace) + "-unser-descriptor.txt"
                files = open(nf1,"rt")
                files.seek(0)
                temp = files.readline()
                linesf1 = files.readlines()
                ...
                nf1 = "tifs2016/temp/faces/face-" + str(firstFace) + "-spytec-descriptor.txt"
                nf2 = "tifs2016/temp/faces/face-" + str(secondFace) + "-spytec-descriptor.txt"
                files = open(nf1,"rt")
                files.seek(0)
                temp = files.readline()
                linesf1 = files.readlines()
                ...
                nf1 = "tifs2016/temp/faces/face-" + str(firstFace) + "-ccv-descriptor.txt"
                nf2 = "tifs2016/temp/faces/face-" + str(secondFace) + "-ccv-descriptor.txt"
                files = open(nf1,"rt")
                files.seek(0)
                temp = files.readline()
                linesf1 = files.readlines()
                ...
                nf1 = "tifs2016/temp/faces/face-" + str(firstFace) + "-lch-descriptor.txt"
                nf2 = "tifs2016/temp/faces/face-" + str(secondFace) + "-lch-descriptor.txt"
                files = open(nf1,"rt")
                files.seek(0)
                temp = files.readline()
                linesf1 = files.readlines()
                ...
                nf1 = "tifs2016/temp/faces/face-" + str(firstFace) + "-eoac-descriptor.txt"
                nf2 = "tifs2016/temp/faces/face-" + str(secondFace) + "-eoac-descriptor.txt"
                files = open(nf1,"rt")
                files.seek(0)
                temp = files.readline()
                linesf1 = files.readlines()
            ...
            nnf1 = "tifs2016/temp/" +  nf1[14:-4] + "-label-" + str(stateFace1) + ".txt"


            shutil.copy(nf1, nnf1)

            nnf2 = "tifs2016/temp/" + nf2[14:-4] + "-label-" + str(stateFace2) + ".txt"

            shutil.copy(nf2, nnf2)
            allVectors.append(newVector)
            print("\n BREAKPOINT 3")
            secondFace = secondFace + 1
        firstFace = firstFace + 1
        nameFile = "tifs2016/temp/vectors/fv-" + image[:-4] + ".txt"
