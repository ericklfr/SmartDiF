...
def buildTrainingTestFiles(dataset, descriptor,space, channel,trainingFolds=[1,2,3,4,5],validationFolds=[],testFolds=[]):
    ...
    npath = "tifs2016/training-test-files/" + tt + "-" + "IIC-" + nameSpace + "-" + nameChannel
    ...
    if (len(trainingFolds) > 0) and (trainingFolds[0] != ''):
        ...
        for i in trainingFolds:
            fd = fd+str(i)+"-"
        fd = fd[:-1]
        outfile = "tifs2016/training-test-files/" + tt + "-" + "IIC-" + nameSpace + "-" + nameChannel + "/" + dataset + "-training-folds-" + fd
        ofid = open(outfile,'wt')
        ofid.seek(0)
        outfilesvm = "tifs2016/training-test-files/" + tt + "-" + "IIC-" + nameSpace + "-" + nameChannel + "/" + dataset + "-svm-training-folds-" + fd
        ofidsvm = open(outfilesvm,'wt')
        ofidsvm.seek(0)
        for i in trainingFolds:
            name = "tifs2016/folds/fold-" + str(i) + ".txt"
            ...
            for j in lines:
                temp = j.split("\n")
                temp = temp[0]
                name = "tifs2016/extracted-feature-vectors/" + tt + "-" + "IIC-" + nameSpace + "-" + nameChannel + "/fv-" + j[:-1]
                print(name)
                actualFile = open(name,"rt")
    ...
    if (len(validationFolds) > 0) and (validationFolds[0] != ''):
        for i in validationFolds:
            fd = fd+str(i)+"-"
        fd = fd[:-1]
        outfile = "tifs2016/training-test-files/" + tt + "-" + "IIC-" + nameSpace + "-" + nameChannel + "/" + dataset + "-validation-folds-" + fd
        ofid = open(outfile,'wt')
        ofid.seek(0)
        outfilesvm = "tifs2016/training-test-files/" + tt + "-" + "IIC-" + nameSpace + "-" + nameChannel + "/" + dataset + "-svm-validation-folds-" + fd
        ofidsvm = open(outfilesvm,'wt')
        ofidsvm.seek(0)
        for i in validationFolds:
            name = "tifs2016/folds/fold-" + str(i) + ".txt"
    ...
    if (len(testFolds) > 0) and (testFolds[0] != ''):
        for i in testFolds:
            fd = fd+str(i)+"-"
        fd = fd[:-1]
        outfile = "tifs2016/training-test-files/" + tt + "-" + "IIC-" + nameSpace + "-" + nameChannel + "/" + dataset + "-test-folds-" + fd
        ofid = open(outfile,'wt')
        ofid.seek(0)
        outfilesvm = "tifs2016/training-test-files/" + tt + "-" + "IIC-" + nameSpace + "-" + nameChannel + "/" + dataset + "-svm-test-folds-" + fd
        ofidsvm = open(outfilesvm,'wt')
        ofidsvm.seek(0)
        for i in testFolds:
            name = "tifs2016/folds/fold-" + str(i) + ".txt"
    ...
    npath = "tifs2016/training-test-files/" + tt + "-" + "GGE-" + nameSpace + "-" + nameChannel
    if not os.path.exists(npath):
        os.makedirs(npath)
    fd = ""
    if (len(trainingFolds) > 0) and (trainingFolds[0] != ''):
        for i in trainingFolds:
            fd = fd+str(i)+"-"
        fd = fd[:-1]
        outfile = "tifs2016/training-test-files/" + tt + "-" + "GGE-" + nameSpace + "-" + nameChannel + "/" + dataset + "-training-folds-" + fd
        ofid = open(outfile,'wt')
        ofid.seek(0)
        outfilesvm = "tifs2016/training-test-files/" + tt + "-" + "GGE-" + nameSpace + "-" + nameChannel + "/" + dataset + "-svm-training-folds-" + fd
        ofidsvm = open(outfilesvm,'wt')
        ofidsvm.seek(0)
        for i in trainingFolds:
            name = "tifs2016/folds/fold-" + str(i) + ".txt"
            ...
            for j in lines:
                temp = j.split("\n")
                temp = temp[0]
                name = "tifs2016/extracted-feature-vectors/" + tt + "-" + "GGE-" + nameSpace + "-" + nameChannel + "/fv-" + j[:-1]
                print(name)
                actualFile = open(name,"rt")
                linesDesc = actualFile.readlines()
                actualFile.close()
    ...
    if (len(validationFolds) > 0) and (validationFolds[0] != ''):
        for i in validationFolds:
            fd = fd+str(i)+"-"
        fd = fd[:-1]
        outfile = "tifs2016/training-test-files/" + tt + "-" + "GGE-" + nameSpace + "-" + nameChannel + "/" + dataset + "-validation-folds-" + fd
        ofid = open(outfile,'wt')
        ofid.seek(0)
        outfilesvm = "tifs2016/training-test-files/" + tt + "-" + "GGE-" + nameSpace + "-" + nameChannel + "/" + dataset + "-svm-validation-folds-" + fd
        ofidsvm = open(outfilesvm,'wt')
        ofidsvm.seek(0)
        for i in validationFolds:
            name = "tifs2016/folds/fold-" + str(i) + ".txt"
    ...
    if (len(testFolds) > 0) and (testFolds[0] != ''):
        for i in testFolds:
            fd = fd+str(i)+"-"
        fd = fd[:-1]
        outfile = "tifs2016/training-test-files/" + tt + "-" + "GGE-" + nameSpace + "-" + nameChannel + "/" + dataset + "-test-folds-" + fd
        ofid = open(outfile,'wt')
        ofid.seek(0)
        outfilesvm = "tifs2016/training-test-files/" + tt + "-" + "GGE-" + nameSpace + "-" + nameChannel + "/" + dataset + "-svm-test-folds-" + fd
        ofidsvm = open(outfilesvm,'wt')
        ofidsvm.seek(0)
        for i in testFolds:
            name = "tifs2016/folds/fold-" + str(i) + ".txt"
